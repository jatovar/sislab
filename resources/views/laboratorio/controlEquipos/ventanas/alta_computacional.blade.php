<div id="ModalComputacional"  class="modal fade" role="dialog">
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
    ...
    <div class="modal-header"; style="height:12%;">
        ...
        <h3 style=""><span class="glyphicon glyphicon-lock"></span> Alta de Equipos Computacionales</h3>
    </div>
  ...
  <div class="modal-body" style="height:78%;overflow-y:scroll">
    ...
    <tr>
      ...
      <td>
        <select id="clasificacion" name="clasificacion" class="clasificacion form-control" name="" >
              @foreach($categoria->clasificaciones() as $c)
                <option value=""></option>
...
<div class="modal-footer"><button type="button" class="btn btn-primary" onclick="guardarEquipo('{{$categoria->id_lab_categoria_inv}}')" >Guardar</button></div>
</div>
